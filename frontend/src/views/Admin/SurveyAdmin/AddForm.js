    ...
    <DndProvider backend={HTML5Backend}>
      <div style={{ textAlign: 'center', maxWidth: '600px', margin: 'auto' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: '5px' }}>
          <button onClick={addBlock} style={{ padding: '12px', backgroundColor: '#21ACD7', color: 'white', border: 'none', marginRight: '10px' }}>Add Block</button>
          <button onClick={addForm} style={{ padding: '12px', backgroundColor: '#21ACD7', color: 'white', border: 'none' }}>Add Form</button>
        </div>
          ...
          <div key={formIndex}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '10px' }}>
              ...
              <button
                ...
                style={{
                  backgroundColor: !form.isActive ? '#21ACD7' : '',
                  color: 'white',
                  padding: '8px',
                  borderRadius: '4px',
                  marginLeft: '10px',
